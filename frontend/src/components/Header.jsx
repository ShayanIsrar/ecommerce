        ...
        <div className='h-full container mx-auto flex items-center px-4 justify-between'>
          ...
          <div className='flex items-center gap-7'>
            ...
            <div>
              {
                user?._id ?(
                  <button onClick={handleLogout} className='px-3 py-1 rounded-full bg-red-500 hover:bg-red-700 text-white'>Logout</button>
                ):(
                  <Link to={"/login"} className='px-3 py-1 rounded-full bg-red-500 hover:bg-red-700 text-white'>Login</Link>
                )
              }
